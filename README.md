...
|TaeHoon Her*, Jaesok Yu|Phase-preserving gray box model for robust sonar signal separation|ASA|New Orleans, Louisiana(May. 2025)|
|TaeHoon Her*, Jaesok Yu|Enhancing Signal Separation Performance in Passive Sonar using Multi-Task Learning|Korea Institude of Military Science & Technology|Jeju, Korea(June. 2025)|
